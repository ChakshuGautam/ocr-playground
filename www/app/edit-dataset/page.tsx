...
export default function EditDatasetPage() {
    ...
    // Set datasetId if id is present in query string
    useEffect(() => {
    ...
    const handleUpdateDataset = async () => {
        ...
        try {
            ...
            if (!response.ok) {
                const errorData = await response.json();
                throw new Error(errorData.error || "Failed to edit dataset");
            }
                    ...
                    <div>
                        ...
                        {datasetId ? (
                            ...
                            <div className="rounded-lg bg-white p-6 shadow-sm text-center text-gray-500">
                                No dataset selected for editing
                            </div>
                        )}
                    </div>
                </div>
